...
import 'package:flutter_reading_app/components/description_text.dart';
import 'package:flutter_reading_app/components/loading_widget.dart';
import 'package:flutter_reading_app/database/locator_helper.dart';
...
class _DetailsState extends State<Details> {
        ...
        return Scaffold(
          ...
          body: ListView(
            ...
            children: <Widget>[
              ...
              _buildDivider(),
              SizedBox(height: 10.0),
              _buildMorreading(detailsProvider),
            ],
          ),
        );
      },
  ...
  _buildMorreading(DetailsProvider provider) {
    if (provider.loading) {
      return Container(
        height: 100.0,
        child: LoadingWidget(),
