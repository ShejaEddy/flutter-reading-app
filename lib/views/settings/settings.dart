...
import 'package:flutter_reading_app/views/downloads/downloads.dart';
import 'package:flutter_reading_app/views/favorites/favorites.dart';
    ...
    showDialog(
      ...
      builder: (_) {
        return AlertDialog(
          ...
          content: Text(
            'Simple reading app by sheja for enriching your brain',
          ),
          actions: <Widget>[
            FlatButton(
